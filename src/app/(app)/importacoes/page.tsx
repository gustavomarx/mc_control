...
function ModalImportarAvec({
  ...
  const concluido = status.some(s => s.id === '__complete')
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-center justify-between px-6 pt-6 pb-4 shrink-0">
          ...
          <button onClick={onFechar} disabled={running} className="text-gray-400 hover:text-gray-600 disabled:opacity-30 p-1">
        ...
        {!extensaoOk ? (
          ...
          <div className="flex flex-col items-center gap-3 px-6 pb-6 py-4 text-center">
          ...
          <>
            ...
            <div className="flex-1 overflow-y-auto px-6 flex flex-col gap-4 min-h-0">
              ...
              {/* Status */}
              {status.length > 0 && (
                <div className="flex flex-col gap-1 border-t border-gray-100 pt-3 pb-1">
                  {status.map(s => (
            ...
            <div className="px-6 py-4 shrink-0">
              {concluido ? (
                <div className="flex flex-col gap-3">
                  <div className="flex items-center gap-2 text-sm font-medium text-emerald-700 bg-emerald-50 border border-emerald-100 rounded-xl px-4 py-3">
                  ...
                  <button
                    onClick={onFechar}
                    className="w-full py-2.5 bg-rose-700 hover:bg-rose-800 text-white text-sm font-semibold rounded-xl transition-colors"
                  >
                    Ok
                  </button>
                </div>
